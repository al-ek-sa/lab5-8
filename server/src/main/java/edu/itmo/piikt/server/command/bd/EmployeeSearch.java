...
/**
 * Utility class for retrieving user identifier from database by login. Provides
 * a single method to fetch user ID from the "user" table.
 *
...
public class EmployeeSearch {
	 ...
	 *
	 * @param clientCommand
	 *            client command containing the user login
