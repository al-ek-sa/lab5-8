...
import edu.itmo.piikt.server.validation.validation.ValidationAddress;
import edu.itmo.piikt.server.validation.validation.ValidationOrganization;
import edu.itmo.piikt.server.validation.validation.ValidationOrganizationType;
