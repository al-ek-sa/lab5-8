...
public enum Commands {
    ...
    INFO("info", "output information about the collection to stdout (type, initialization date, number of elements, etc.)",
    ...
    COUNT_BY_ORGANIZATION("count_by_organization", "output the number of elements whose organization field value is equal to the specified one",
    ...
    FILTER_CONTAINS_NAME("filter_contains_name", "output elements whose name field value contains the specified substring",
    ...
    PRINT_FIELD_DESCENDING_END_DATE("print_field_descending_end_date", "output the values of the endDate field of all elements in descending order",
