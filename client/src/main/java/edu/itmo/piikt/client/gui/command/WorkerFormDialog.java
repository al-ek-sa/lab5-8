...
public class WorkerFormDialog extends JDialog {
    ...
    public WorkerFormDialog(JFrame parent, MainAppPanel mainAppPanel, String username, boolean isEditMode, int rowIndex, Object[] rowData) {
    ...
    private void fillFields(Object[] rowData) {
        if (rowData.length > 1) nameField.setText(rowData[1] != null ? rowData[1].toString() : "");
        if (rowData.length > 2) coordinateXField.setText(rowData[2] != null ? rowData[2].toString() : "");
        if (rowData.length > 3) coordinateYField.setText(rowData[3] != null ? rowData[3].toString() : "");
        if (rowData.length > 4) salaryField.setText(rowData[4] != null ? rowData[4].toString() : "");
        if (rowData.length > 5) startDateField.setText(rowData[5] != null ? rowData[5].toString() : "");
        if (rowData.length > 6) endDateField.setText(rowData[6] != null ? rowData[6].toString() : "");
        if (rowData.length > 7 && rowData[7] != null) statusComboBox.setSelectedItem(rowData[7].toString());
        if (rowData.length > 8) annualTurnoverField.setText(rowData[8] != null ? rowData[8].toString() : "");
        if (rowData.length > 9 && rowData[9] != null) organizationTypeComboBox.setSelectedItem(rowData[9].toString());
        if (rowData.length > 10) addressField.setText(rowData[10] != null ? rowData[10].toString() : "");
    }
    ...
    private void onSave() {
        ...
        Object[] newWorkerData = new Object[]{
                null,
                nameField.getText().trim(),
                coordinateXField.getText().trim(),
                coordinateYField.getText().trim(),
                salaryField.getText().trim(),
                startDateField.getText().trim(),
                endDateField.getText().trim(),
                statusComboBox.getSelectedItem(),
                annualTurnoverField.getText().trim(),
                organizationTypeComboBox.getSelectedItem(),
