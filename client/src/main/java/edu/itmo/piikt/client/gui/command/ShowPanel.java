...
public class ShowPanel extends JPanel {
    ...
    private void addTestData() {
        Object[] row1 = {1, "Иван Иванов", 5, 10, 50000, "2023-01-15", "2024-01-15", "HIRED", 1000000, "COMMERCIAL", "ул. Ленина, 10"};
        Object[] row2 = {2, "Петр Петров", 3, -5, 75000, "2022-06-01", null, "PROBATION", 2500000, "GOVERNMENT", "пр. Мира, 25"};
        Object[] row3 = {3, "Сидор Сидоров", 8, 15, 60000, "2023-09-10", "2025-09-10", "FIRED", 500000, "TRUST", "ул. Садовая, 7"};
        Object[] row4 = {4, "Анна Смирнова", 2, 20, 90000, "2021-03-20", null, "RECOMMENDED_FOR_PROMOTION", 5000000, "OPEN_JOINT_STOCK_COMPANY", "б-р. Победы, 1"};
    ...
    private void onDeleteByDate() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Неверный формат даты. Используйте формат: ГГГГ-ММ-ДД", "Ошибка", JOptionPane.ERROR_MESSAGE);
        }
    }

    private void onClear() {
        int confirm = JOptionPane.showConfirmDialog(this, "Очистить всю таблицу?", "Подтверждение", JOptionPane.YES_NO_OPTION);
        if (confirm == JOptionPane.YES_OPTION) {
            tableModel.setRowCount(0);
        }
    }
